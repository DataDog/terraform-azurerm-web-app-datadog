...
The example includes a local code deployment step that packages and deploys the sample Python application (app.py and requirements.txt) to the staging slot. Note: we intentionally aren't deploying to the main web app since that isn't relevant to this example.
