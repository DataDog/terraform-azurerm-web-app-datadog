...
| <a name="input_sidecar_image"></a> [sidecar\_image](#input\_sidecar\_image) | Datadog sidecar container image. | `string` | `"index.docker.io/datadog/serverless-init:latest"` | no |
