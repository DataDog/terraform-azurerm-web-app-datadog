# Datadog Azure Windows Web App Slot Terraform Module

Use [this Terraform module](https://registry.terraform.io/modules/DataDog/web-app-datadog/azurerm/latest/submodules/windows-slot) to deploy an Azure Windows Web App Deployment Slot with integrated Datadog monitoring.
...
```hcl
module "windows_web_app_slot_datadog" {
  source = "DataDog/web-app-datadog/azurerm//modules/windows-slot"

  name           = "staging"
  app_service_id = module.windows_web_app_datadog.id
...
This module exposes all supported arguments available in the [azurerm_windows_web_app_slot](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/windows_web_app_slot) resource. Configuration blocks are provided as nested objects or maps, as shown in the example above. See the [Inputs](#inputs) section for all supported variables.
...
|------|-------------|------|---------|:--------:|
| <a name="input_app_service_id"></a> [app\_service\_id](#input\_app\_service\_id) | The ID of the Windows Web App this Deployment Slot will be part of. Changing this forces a new Windows Web App to be created. | `string` | n/a | yes |
...
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Should the Windows Web App Slot be enabled? Defaults to `true`. | `bool` | `null` | no |
...
| <a name="input_https_only"></a> [https\_only](#input\_https\_only) | Should the Windows Web App Slot require HTTPS connections. Defaults to `false`. | `bool` | `null` | no |
...
| <a name="input_name"></a> [name](#input\_name) | The name which should be used for this Windows Web App Slot. Changing this forces a new Windows Web App Slot to be created. | `string` | n/a | yes |
...
| <a name="input_tags"></a> [tags](#input\_tags) | A mapping of tags which should be assigned to the Windows Web App Slot. | `map(string)` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_app_service_id"></a> [app\_service\_id](#output\_app\_service\_id) | The ID of the Windows Web App this Deployment Slot will be part of. Changing this forces a new Windows Web App to be created. |
...
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Should the Windows Web App Slot be enabled? Defaults to `true`. |
...
| <a name="output_https_only"></a> [https\_only](#output\_https\_only) | Should the Windows Web App Slot require HTTPS connections. Defaults to `false`. |
...
| <a name="output_name"></a> [name](#output\_name) | The name which should be used for this Windows Web App Slot. Changing this forces a new Windows Web App Slot to be created. |
...
| <a name="output_service_plan_id"></a> [service\_plan\_id](#output\_service\_plan\_id) | The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Web App will be used. |
...
| <a name="output_tags"></a> [tags](#output\_tags) | A mapping of tags which should be assigned to the Windows Web App Slot. |
...
| <a name="output_virtual_network_image_pull_enabled"></a> [virtual\_network\_image\_pull\_enabled](#output\_virtual\_network\_image\_pull\_enabled) | Whether traffic for the image pull should be routed over the virtual network. Defaults to `false`. |
