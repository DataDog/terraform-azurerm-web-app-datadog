...
resource "azurerm_windows_web_app" "this" {
  ...
  site_config {
      ...
      content {
        action {
          ...
          dynamic "custom_action" {
            for_each = var.site_config.auto_heal_setting.action.custom_action != null ? [true] : []
            content {
              executable = var.site_config.auto_heal_setting.action.custom_action.executable
              parameters = var.site_config.auto_heal_setting.action.custom_action.parameters
            }
          }
        }
        trigger {
          private_memory_kb = var.site_config.auto_heal_setting.trigger.private_memory_kb
          dynamic "requests" {
    ...
    dynamic "handler_mapping" {
      for_each = var.site_config.handler_mapping != null ? var.site_config.handler_mapping : []
      content {
    ...
    dynamic "virtual_application" {
      for_each = var.site_config.virtual_application != null ? var.site_config.virtual_application : []
      content {
