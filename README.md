...
Use [these Terraform modules](https://registry.terraform.io/modules/DataDog/web-app-datadog/azurerm/latest) to install Datadog Serverless Monitoring for Azure Linux & Windows Web Apps and their deployment slots.
